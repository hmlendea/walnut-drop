...
namespace WalnutDrop.Model
{
    public sealed class RoundDefinition
    {
        ...
        static RoundDefinition()
        {
            ...
            [
                new RoundDefinition(1, 10,  [2,  2,  2,  2,  2,  2,  2,  2]),
                new RoundDefinition(2, 40,  [21, 13, 8,  5,  5,  8,  13, 21]),
                new RoundDefinition(3, 20,  [8,  6,  4,  2,  2,  4,  6,  8]),
                new RoundDefinition(4, 80,  [64, 49, 36, 25, 25, 36, 49, 64])
            ];

            All = rounds.AsReadOnly();
        }

        private RoundDefinition(
            int roundNumber,
            int targetScore,
            int[] slotValues)
        {
